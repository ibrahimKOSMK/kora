...
<nav class="border-teal bg-niga dark:bg-gray-800 dark:border-gray-700">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
      ...
      <a
        href="#!"
        type="button"
        class="rounded-full p-3 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-teal focus:outline-none focus:ring-0 text-white dark:hover:bg-secondary-900"
        data-twe-ripple-init>
      ...
      <a
        href="#!"
        type="button"
        class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-teal focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
        data-twe-ripple-init>
        <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
